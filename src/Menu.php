...
class Menu
{
    ...
    {
        add_action('admin_menu', array($this, 'kopokopo_transactions_menu'));
    }
    ...
    function kopokopo_transactions_menu()
    {
        add_submenu_page(
            ...
            'manage_options',
            'kopokopo_about',
            array($this, 'kopokopo_transactions_menu_about')
        );
        ...
        add_submenu_page(
            ...
            'manage_options',
            'kopokopo_options',
            array($this,  'kopokopo_transactions_menu_pref')
        );
    }
    ...
    { ?>
        <div class="wrap">
            ...
            <h4><?php _e('Get in touch with us either via email', 'woocommerce'); ?> (<a href="mail-to:hi@osen.co.ke">hi@osen.co.ke</a>) or via phone(<a href="tel:+254204404993">+254204404993</a>)</h4>
        </div>
<?php
    }
